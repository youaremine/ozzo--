...
class StoreProductSeckill extends BaseController
{
    ...
    public function lst()
    {
        ...
        $where = $this->request->params(['cate_id', 'keyword', ['type', 1], 'mer_cate_id', 'pid','seckill_status','order','is_trader','us_status','star','product_id']);
    ...
    public function switchStatus()
    {
        ...
        $this->repository->switchStatus($id,$data,1);
